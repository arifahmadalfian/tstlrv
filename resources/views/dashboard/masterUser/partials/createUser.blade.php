<label class="btn btn-warning" for="modalAdd">Add User</label>
<input class="modal-state" id="modalAdd" type="checkbox" />
<div class="modal">
	<label class="modal-overlay" for="modalAdd"></label>
	<div class="modal-content flex flex-col gap-5 p-3">
		<label for="modalAdd" class="btn btn-sm btn-circle btn-ghost absolute right-2 top-2">✕</label>
		<h2 class="text-xl">Add User</h2>
		<div class="p-4 shadow-lg">
            <form class="space-y-4" action="{{route('dashboard.users.create')}}" method="POST">
                <div class="w-full">
